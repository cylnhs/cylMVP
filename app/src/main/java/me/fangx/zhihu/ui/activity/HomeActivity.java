...
public class HomeActivity extends BaseAppCompatActivity {
    ...
    private void init() {
     ...
     //   user_img.setImageURI(Uri.parse("http://upload.wikimedia.org/wikipedia/en/thumb/7/7a/Manchester_United_FC_crest.svg/1010px-Manchester_United_FC_crest.svg.png"));
    }
